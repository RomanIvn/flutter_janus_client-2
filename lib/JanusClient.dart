...
class JanusClient {
  ...
  * */
  ...
  JanusClient({this.transport, this.iceServers, this.refreshInterval = 50, this.apiSecret, this.isUnifiedPlan = false, this.token, this.maxEvent = 10, this.withCredentials = false});
